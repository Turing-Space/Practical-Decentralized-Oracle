    ...
    context('N voters', function () {
        it("Exp", async function(){
            ...
            for (var m = 0; m<M; m++){
                ...
                consensus[m] = custodian.address;

                // All clients vote for custodian m
                for (var n = 0; n<N; n++){
                    await clients[n].vote(consensus[m], true);  // HAS AWAIT
                }
            ...
            for (var m = 10; m<M; m+=10) {
                ...
                for (var j = 0; j<max_trial;j++){
                    ...
                    for (var c = 0; c<m; c++) {
                        ...
                        custodian = Custodian.at(consensus[c]);
                        ...
                        for (var i = 0; i < N; i++) { clients[i].vote(custodian, false); }
                    }
                    await sleep(800);
                ...
                writeToFile(m.toString(), ans_array_per_m);
            }
        }).timeout(3000000000);
